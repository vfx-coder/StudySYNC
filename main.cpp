...
// Each Subject(completion, updation)
...
int main()
{
    ...
    for (int idx : studiedIndices)
    {
        ...
        if (data[idx].completion > 100)
            data[idx].completion = 100;
        cout << "\n"
    ...
    cout << "\n Time Usage: " << totalAllocated << " / " << totalStudyHours << " hours\n";
    ...
    for (auto &s : data)
    {
        ...
        else
        {
            ...
            {
                cout << " |  Need " << daysNeeded << " days, only " << s.daysLeft << " left!";
            }
        }
        cout << endl;
    }
